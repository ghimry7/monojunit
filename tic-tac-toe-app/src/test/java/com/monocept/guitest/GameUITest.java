...
import com.monocept.model.InavlidCellLocationException;
...
class GameUITest {
	...
	@Test
	void testInvalidLocationException() {
		assertThrows(ArrayIndexOutOfBoundsException.class, () -> bton[9].doClick());
	}
